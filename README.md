...
[![Node CI Status](https://github.com/taktikorg/numquam-velit-vero/workflows/Node%20CI/badge.svg)](https://github.com/taktikorg/numquam-velit-vero/actions)
[![npm](https://img.shields.io/npm/v/@taktikorg/numquam-velit-vero.svg)](https://www.npmjs.com/package/@taktikorg/numquam-velit-vero)
[![codecov](https://codecov.io/gh/taktikorg/numquam-velit-vero/branch/master/graph/badge.svg)](https://codecov.io/gh/taktikorg/numquam-velit-vero)
...
```sh
npm install --save @taktikorg/numquam-velit-vero
```
...
```js
const { validator } = require('@taktikorg/numquam-velit-vero')
...
```js
const { parser } = require('@taktikorg/numquam-velit-vero')
...
`@taktikorg/numquam-velit-vero` supports the formats specified in JSON schema v4 (such as date-time).
...
When the `includeErrors` option is set to `true`, `@taktikorg/numquam-velit-vero` also outputs:
...
See the [doc/samples](./doc/samples/) directory to see how `@taktikorg/numquam-velit-vero` compiles
...
`@taktikorg/numquam-velit-vero` uses code generation to turn a JSON schema into javascript code that is easily
...
```sh
git clone https://github.com/taktikorg/numquam-velit-vero
cd schemasafe
...
Compared to `is-my-json-valid`, `@taktikorg/numquam-velit-vero` adds security-first design, many new features,
